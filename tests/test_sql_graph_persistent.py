...
class TestSQLGraphPersistent(unittest.TestCase):
    def setUp(self) -> None:
        ...
        assets = [
            Asset(asset_id="1", name="table-1", type=AssetType.RTABLE, aspects={
                "semantic_properties": SemanticAspect(name="table-1-semantic", description="test", keywords=[]),
                "statistical_properties": RTableStatisticsAspect(
                    name="table-1-statistic", num_rows=0, num_columns=0
                ),
                "schema_properties": RTableSchemaAspect(name="table-1-schema", indices={}, pks=[])
            }),
            Asset(asset_id="2", name="table-2", type=AssetType.RTABLE, aspects={
                "semantic_properties": SemanticAspect(name="table-2-semantic", description="test", keywords=[]),
                "statistical_properties": RTableStatisticsAspect(
                    name="table-2-statistic", num_rows=0, num_columns=0
                ),
                "schema_properties": RTableSchemaAspect(name="table-2-schema", indices={}, pks=[])
            }),
            Asset(asset_id="3", name="table-3", type=AssetType.RTABLE, aspects={
                "semantic_properties": SemanticAspect(name="table-3-semantic", description="test", keywords=[]),
                "statistical_properties": RTableStatisticsAspect(
                    name="table-3-statistic", num_rows=0, num_columns=0
                ),
                "schema_properties": RTableSchemaAspect(name="table-3-schema", indices={}, pks=[])
            }),
            Asset(asset_id="4", name="column-1-1", type=AssetType.RCOLUMN, aspects={
                "semantic_properties": SemanticAspect(name="column-1-1-semantic", description="test", keywords=[]),
                "statistical_properties": RColumnStatisticsAspect(
                    name="column-1-1-statistic", non_null_count=0, null_count=0, numerical_stats=RNumericalStatistics(
                        min=0, max=0, mean=0
                    ), categorical_stats=None
                ),
                "schema_properties": RColumnSchemaAspect(
                    name="column-1-1-schema", dtype="TEXT", is_nullable=False, is_pk=False
                )
            }),
            Asset(asset_id="5", name="column-1-2", type=AssetType.RCOLUMN, aspects={
                "semantic_properties": SemanticAspect(name="column-1-2-semantic", description="test", keywords=[]),
                "statistical_properties": RColumnStatisticsAspect(
                    name="column-1-2-statistic", non_null_count=0, null_count=0, numerical_stats=None,
                    categorical_stats=RCategoricalStatistics(
                        value_counts={"1": 1, "2": 2}
                    )
                ),
                "schema_properties": RColumnSchemaAspect(
                    name="column-1-2-schema", dtype="TEXT", is_nullable=False, is_pk=False
                )
            }),
            Asset(asset_id="6", name="column-2-1", type=AssetType.RCOLUMN, aspects={
                "semantic_properties": SemanticAspect(name="column-2-1-semantic", description="test", keywords=[]),
                "statistical_properties": RColumnStatisticsAspect(
                    name="column-2-1-statistic", non_null_count=0, null_count=0, numerical_stats=RNumericalStatistics(
                        min=0, max=0, mean=0
                    ), categorical_stats=None
                ),
                "schema_properties": RColumnSchemaAspect(
                    name="column-2-1-schema", dtype="TEXT", is_nullable=False, is_pk=False
                )
            }),
            Asset(asset_id="7", name="column-2-2", type=AssetType.RCOLUMN, aspects={
                "semantic_properties": SemanticAspect(name="column-2-2-semantic", description="test", keywords=[]),
                "statistical_properties": RColumnStatisticsAspect(
                    name="column-2-2-statistic", non_null_count=0, null_count=0, numerical_stats=None,
                    categorical_stats=RCategoricalStatistics(
                        value_counts={"1": 1, "2": 2}
                    )
                ),
                "schema_properties": RColumnSchemaAspect(
                    name="column-2-2-schema", dtype="TEXT", is_nullable=False, is_pk=False
                )
            }),
            Asset(asset_id="8", name="column-3-1", type=AssetType.RCOLUMN, aspects={
                "semantic_properties": SemanticAspect(name="column-3-1-semantic", description="test", keywords=[]),
                "statistical_properties": RColumnStatisticsAspect(
                    name="column-3-1-statistic", non_null_count=0, null_count=0, numerical_stats=RNumericalStatistics(
                        min=0, max=0, mean=0
                    ), categorical_stats=None
                ),
                "schema_properties": RColumnSchemaAspect(
                    name="column-3-1-schema", dtype="TEXT", is_nullable=False, is_pk=False
                )
            }),
            Asset(asset_id="9", name="column-3-2", type=AssetType.RCOLUMN, aspects={
                "semantic_properties": SemanticAspect(name="column-3-2-semantic", description="test", keywords=[]),
                "statistical_properties": RColumnStatisticsAspect(
                    name="column-3-2-statistic", non_null_count=0, null_count=0, numerical_stats=None,
                    categorical_stats=RCategoricalStatistics(
                        value_counts={"1": 1, "2": 2}
                    )
                ),
                "schema_properties": RColumnSchemaAspect(
                    name="column-3-2-schema", dtype="TEXT", is_nullable=False, is_pk=False
                )
            }),
        ]
        links = [
    ...
    def test_link(self):
        ...
        self.assertEqual(link.aspects["foreign_key_properties"].name, "table-1-table-2-fk")
    ...
    def test_get_aspects_of_asset_numerical_column(self):
        ...
        self.assertTrue("schema_properties" in aspects)
        self.assertTrue("semantic_properties" in aspects)
        self.assertIsInstance(aspects["statistical_properties"], RColumnStatisticsAspect)
